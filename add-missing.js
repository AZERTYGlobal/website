// Script to add missing entries to character-index.json in the correct Unicode position
const fs = require('fs');
...
// AZERTY key mapping
const keyToCode = {
  'a': { key: 'KeyQ', layer: 'Base' }, 'A': { key: 'KeyQ', layer: 'Shift' },
  'b': { key: 'KeyB', layer: 'Base' }, 'B': { key: 'KeyB', layer: 'Shift' },
  'c': { key: 'KeyC', layer: 'Base' }, 'C': { key: 'KeyC', layer: 'Shift' },
  'd': { key: 'KeyD', layer: 'Base' }, 'D': { key: 'KeyD', layer: 'Shift' },
  'e': { key: 'KeyE', layer: 'Base' }, 'E': { key: 'KeyE', layer: 'Shift' },
  'f': { key: 'KeyF', layer: 'Base' }, 'F': { key: 'KeyF', layer: 'Shift' },
  'g': { key: 'KeyG', layer: 'Base' }, 'G': { key: 'KeyG', layer: 'Shift' },
  'h': { key: 'KeyH', layer: 'Base' }, 'H': { key: 'KeyH', layer: 'Shift' },
  'i': { key: 'KeyI', layer: 'Base' }, 'I': { key: 'KeyI', layer: 'Shift' },
  'j': { key: 'KeyJ', layer: 'Base' }, 'J': { key: 'KeyJ', layer: 'Shift' },
  'k': { key: 'KeyK', layer: 'Base' }, 'K': { key: 'KeyK', layer: 'Shift' },
  'l': { key: 'KeyL', layer: 'Base' }, 'L': { key: 'KeyL', layer: 'Shift' },
  'm': { key: 'Semicolon', layer: 'Base' }, 'M': { key: 'Semicolon', layer: 'Shift' },
  'n': { key: 'KeyN', layer: 'Base' }, 'N': { key: 'KeyN', layer: 'Shift' },
  'o': { key: 'KeyO', layer: 'Base' }, 'O': { key: 'KeyO', layer: 'Shift' },
  'p': { key: 'KeyP', layer: 'Base' }, 'P': { key: 'KeyP', layer: 'Shift' },
  'q': { key: 'KeyA', layer: 'Base' }, 'Q': { key: 'KeyA', layer: 'Shift' },
  'r': { key: 'KeyR', layer: 'Base' }, 'R': { key: 'KeyR', layer: 'Shift' },
  's': { key: 'KeyS', layer: 'Base' }, 'S': { key: 'KeyS', layer: 'Shift' },
  't': { key: 'KeyT', layer: 'Base' }, 'T': { key: 'KeyT', layer: 'Shift' },
  'u': { key: 'KeyU', layer: 'Base' }, 'U': { key: 'KeyU', layer: 'Shift' },
  'v': { key: 'KeyV', layer: 'Base' }, 'V': { key: 'KeyV', layer: 'Shift' },
  'w': { key: 'KeyZ', layer: 'Base' }, 'W': { key: 'KeyZ', layer: 'Shift' },
  'x': { key: 'KeyX', layer: 'Base' }, 'X': { key: 'KeyX', layer: 'Shift' },
  'y': { key: 'KeyY', layer: 'Base' }, 'Y': { key: 'KeyY', layer: 'Shift' },
  'z': { key: 'KeyW', layer: 'Base' }, 'Z': { key: 'KeyW', layer: 'Shift' },
  '0': { key: 'Digit0', layer: 'Shift' }, '1': { key: 'Digit1', layer: 'Shift' },
  '2': { key: 'Digit2', layer: 'Shift' }, '3': { key: 'Digit3', layer: 'Shift' },
  '4': { key: 'Digit4', layer: 'Shift' }, '5': { key: 'Digit5', layer: 'Shift' },
  '6': { key: 'Digit6', layer: 'Shift' }, '7': { key: 'Digit7', layer: 'Shift' },
  '8': { key: 'Digit8', layer: 'Shift' }, '9': { key: 'Digit9', layer: 'Shift' },
  '+': { key: 'Equal', layer: 'Shift' }, '-': { key: 'Digit6', layer: 'Base' },
  '=': { key: 'Equal', layer: 'Base' }, '/': { key: 'Slash', layer: 'Shift' },
  ':': { key: 'Slash', layer: 'Base' }, '*': { key: 'Backslash', layer: 'Base' },
  '.': { key: 'Period', layer: 'Base' }, ',': { key: 'KeyM', layer: 'Base' },
  '<': { key: 'IntlBackslash', layer: 'Base' }, '>': { key: 'IntlBackslash', layer: 'Shift' },
  ' ': { key: 'Space', layer: 'Base' }, '%': { key: 'Minus', layer: 'Shift' },
  '~': { key: 'KeyN', layer: 'AltGr' }, '@': { key: 'Backquote', layer: 'Base' },
  '|': { key: 'KeyH', layer: 'AltGr' }, '$': { key: 'BracketRight', layer: 'Base' },
  '£': { key: 'BracketRight', layer: 'Shift' }, '^': { key: 'BracketLeft', layer: 'Base' },
  '¨': { key: 'BracketLeft', layer: 'Shift' }, '_': { key: 'Digit8', layer: 'Base' },
  '°': { key: 'Minus', layer: 'AltGr' }, 'à': { key: 'Digit0', layer: 'Base' },
};
...
const sortedIdx = {};
const sortedKeys = Object.keys(idx).sort((a, b) => a.codePointAt(0) - b.codePointAt(0));

for (const key of sortedKeys) {
  sortedIdx[key] = idx[key];
}

// Write back
fs.writeFileSync('tester/character-index.json', JSON.stringify(sortedIdx, null, 4));

console.log('Done! Added missing entries and sorted by Unicode.');
